...
public class ReporteController {
    ...
    public String reportes(
        ...
        if (!esAdmin && usuario.getSucursal() != null) idSucursal = usuario.getSucursal().getIdSucursal();
    ...
    public String corteCaja(
        ...
        if (idSucursal == 0 && usuario.getSucursal() != null) idSucursal = usuario.getSucursal().getIdSucursal();
